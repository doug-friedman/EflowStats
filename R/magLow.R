...
#' @param drainArea A numeric specifying the drainage area. Only required for ml22 statistic. See details.
#' @param pref A character of either "mean" or "median", indicating whether to use mean or median. See details.
#' @param ... Optional arguments needed for \code{hitStats} function
...
#' drainArea <- 50
#' yearType = "water"
#' magLow(x=x,yearType=yearType,drainArea=drainArea)
#' 
